...
{
    /// - Returns: The desired (general) offset you wish the Marker to have on the x-axis.
    /// By returning x: -(width / 2) you will center the Marker horizontally.
    /// By returning y: -(height / 2) you will center the Marker vertically.
    ...
    ///
    /// - Parameters:
    ///   - entry: The Entry the Marker belongs to. This can also be any subclass of Entry, like BarEntry or CandleEntry, simply cast it at runtime.
